...
import {getBandPosition, isFieldDef, isFieldOrDatumDef, TypedFieldDef} from '../../../channeldef';
...
export function positionRef(
  ...
  const {channel, channelDef, scaleName, stack, offset, markDef, config} = params;
